...
export default function Permissions() {
  ...
  const [editingEntry, setEditingEntry] = useState<Permission | null>(null);
  ...
  const handleEdit = (entry: Permission) => {
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white">Gerenciar Permissões</h1>
            <p className="text-white">Registro de permissões do sistema</p>
          </div>
          <Button
        ...
        <Card>
          <CardHeader>
            <CardTitle>Registros de permissões</CardTitle>
            <CardDescription>
                ...
                {filteredEntries.length === 0 ? (
                  ...
                  filteredEntries.map((entry) => (
                    <TableRow key={entry._id}>
                      <TableCell className="max-w-md truncate">{entry.name}</TableCell>
